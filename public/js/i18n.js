  ...
  dict: {
    zh: {
      ...
      aiSettings: {
        ...
        reset: "重置",
        // HTML static text
        heroTitle: "管理 AI 端点和默认模型",
        heroDesc: "保存应用使用的公开 AI 设置，无需重新部署站点。",
        heroTagOpenai: "OpenAI 兼容",
        heroTagProxy: "代理友好",
        heroTagLoading: "正在加载配置...",
        securityNote: "安全提示",
        securityDesc: "请将密钥保留在 Cloudflare 环境变量中。本页面仅存储公开的端点和模型名称。",
        currentConfig: "当前配置",
        configHint: "留空字段将回退到环境变量默认值。",
        labelEndpoint: "AI 端点 URL",
        hintEndpoint: "使用任何支持 chat-completions 风格 API 的端点。",
        labelModel: "默认模型",
        hintModel: "例如：gpt-4o-mini、gpt-4.1-mini 或任何兼容模型名称。",
        btnSaveConfig: "保存配置",
        btnResetDefault: "重置为默认",
        btnBackHome: "返回首页",
        loadingConfig: "正在加载配置...",
        // JS strings
        lastUpdated: "最后更新：",
        configLoaded: "配置已加载",
        noCustomConfig: "尚未保存自定义 AI 配置",
    ...
    en: {
      ...
      aiSettings: {
        ...
        reset: "Reset",
        // HTML static text
        heroTitle: "Manage AI endpoints and default model",
        heroDesc: "Save the public AI settings used by the app without redeploying the site.",
        heroTagOpenai: "OpenAI compatible",
        heroTagProxy: "Proxy friendly",
        heroTagLoading: "Loading config...",
        securityNote: "Security note",
        securityDesc: "Keep the secret key in Cloudflare environment variables. This page stores only the public endpoint and model name.",
        currentConfig: "Current config",
        configHint: "Leave a field empty to fall back to environment defaults.",
        labelEndpoint: "AI endpoint URL",
        hintEndpoint: "Use any endpoint that supports a chat-completions style API.",
        labelModel: "Default model",
        hintModel: "Example: gpt-4o-mini, gpt-4.1-mini, or any compatible model name.",
        ...
        noCustomConfig: "No custom AI config has been saved",
